...
#define LV_TXT_LINE_BREAK_LONG_LEN 8
...
#if LV_USE_FS_POSIX
    #define LV_FS_POSIX_LETTER 'F'      /**< Set an upper-case driver-identifier letter for this driver (e.g. 'A'). */
    #define LV_FS_POSIX_PATH ""         /**< Set the working directory. File/directory paths will be appended to it. */
    #define LV_FS_POSIX_CACHE_SIZE 8192 /**< >0 to cache this number of bytes in lv_fs_read() */
#endif
